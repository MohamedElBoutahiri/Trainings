...
public class GUI {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("File separator");
		...
		gbl_panel_2.columnWidths = new int[]{238, 0};
		gbl_panel_2.rowHeights = new int[]{324, 0};
		...
		gbl_panel_1.columnWidths = new int[]{0, 20, 0, 0, 0, 0};
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Hola", "Cabron", "Mamon"}));
